	...
	let getHospital = async (sidoCdNm, sgguCdNm) => {		
		let resp = await fetch(`http://52.78.231.59:5000/api/hospital?sidoCdNm=${sidoCdNm}&sgguCdNm=${sgguCdNm}`);
	...
	let getSgguCdNm = async (sidoCdNm) => {
		let resp = await fetch(`http://52.78.231.59:5000/api/sgguCdNm?sidoCdNm=${sidoCdNm}`);
		let respPasing = await resp.json();
		//console.log(respPasing);
